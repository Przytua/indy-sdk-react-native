...
const indy = {
  ...
  async verifierVerifyProof(proofRequest, proof, schemas, credentialDefs, revRegDef, revStates) {
    return IndySdk.verifierVerifyProof(JSON.stringify(proofRequest), JSON.stringify(proof), JSON.stringify(schemas), JSON.stringify(credentialDefs), revRegDef && JSON.stringify(revRegDef), JSON.stringify(revStates));
  },
